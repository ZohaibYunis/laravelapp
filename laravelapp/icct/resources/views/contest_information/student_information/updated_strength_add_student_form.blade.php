        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header bg-card-blue" style="padding-bottom: 10px">
                    <h4 class="title text-left" style="color: white; ">Grade {{$student_strength->class_id}}:Add Student Information </h4>
                ...
                <div class="content">
                    <form action="{{route('storeStudentInfo')}}" method="post">
                        ...
                        if ($activated_contest[0]['contest_category_id'] == $student_strength->fk_contest_cat_id) {
                            ...
                            echo "<h3>" . $activated_contest[1]['contest_category_name'] . "</h3>";
                        }
                        ?>
                        <table class="table  table-responsive table-no-bordered">
                            ...
                            <tbody>
                            @php $j=0; @endphp
                            @for($i=1;$i<=$updated_students_counts;$i++)
                                <tr>

                                    <input type="hidden" name="total_student_strength" value="{{$updated_students_counts}}">
                                    ...
                                    <td>
                                        <input type="text" name="student_father_name[]" value="" class="form-control">
                                        {{--@if ($errors->has('student_father_name.'.$j))--}}
                                            {{--<em class=" has-error error help-block">{{ $errors->first('student_father_name.'.$j) }}</em>--}}
                                        {{--@endif--}}
                                    </td>
                                    <td>
                                        <input type="text" name="student_father_cell_no[]" value="" class="form-control">
