                    ...
                    <table id="datatables" class="table table-bordered">
                        ...
                        @foreach($institutes_info as  $row)
                            <tr>
                                ...
                                <td>
                                    <a  class="text-primary " href="{{route("viewInstStudentInfo",["id"=>$row->user_id])}}"><i class="fa fa-user"></i></a>
                                    <a class="text-warning " href="{{route("viewPaymentFile",["id"=>$row->user_id])}}"><i class="fa fa-money"  style="font-size: 1.25em;"></i></a>
                                    <a class="text-success " href="{{route("editInstInfoAdm",["id"=>$row->user_id])}}"><i class="fa fa-pencil"  style="font-size: 1.25em;"></i></a>
                                    {{--<a class="text-danger" data-toggle="modal" data-target="#deleteModalCenter"><i class="fa fa-trash"  style="font-size: 1.25em;"></i></a>--}}
                                    <a class="text-danger remove-record" data-toggle="modal" data-url="{!! URL::route('deleteInst',['id'=>$row->user_id]) !!}" data-id="{{$row->user_id}}" data-target="#custom-width-modal"><i class="fa fa-trash"  style="font-size: 1.25em;"></i></a>
                                </td>
                                <td>{{""}}</td>
                ...
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header navbar-ct-blue" >
                            ...
                            <h4 class="modal-title" id="custom-width-modalLabel">Delete Institute</h4>
                        </div>
                        <div class="modal-body">
                            <h4>Do you really want to delete this institute ?</h4>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-danger btn-fill waves-effect waves-light">Delete</button>
                        </div>
                    </div>
                </div>
            </div>
